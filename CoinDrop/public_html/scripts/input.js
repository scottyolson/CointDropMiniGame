...
/*global MYGAME *///from Dean
// ------------------------------------------------------------------
//
//
//
// ------------------------------------------------------------------
COINGAME.inCircle = function(centerX, centerY, mouseX, mouseY, r) {
    var dx = centerX - mouseX;
    var dy = centerY - mouseY;
    return ((dx * dx) + (dy * dy) <= r * r);
};

COINGAME.input = (function() {
    'use strict';
    ...
    function Mouse() {
        ...
        function mouseUp(e) {
            ...
            //see if what was click crosses the path of any objects
        }
